...
export const APP_CONFIG = {
  ...
  AUTH_SESSION_COOKIE_NAME: getEnv(process.env.AUTH_SESSION_COOKIE_NAME, "signature_analysis_session"),
  AUTH_SESSION_DAYS: getNumber(process.env.AUTH_SESSION_DAYS, 30),
} as const;
