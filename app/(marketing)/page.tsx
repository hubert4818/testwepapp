    ...
    <div className="container space-y-16 py-10 md:py-16">
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        ...
        <InfoBanner
          ...
          description={`Thông tin chuyển khoản, prefix và hỗ trợ được cấu hình sẵn để đồng bộ giữa marketing và khu vực làm việc.`}
      ...
      <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        >
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-border/70 bg-background p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">Tách sẵn khu marketing, khu vực người dùng và quản trị để phát triển song song.</p>
            </div>
            <div className="rounded-2xl border border-border/70 bg-background p-5">
        ...
        <div className="space-y-6">
          <InfoBanner
            ...
            description="Thông tin gói dịch vụ, mức tham chiếu và luồng sử dụng được thể hiện nhất quán để giảm nhầm lẫn cho người dùng mới."
